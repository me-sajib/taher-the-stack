...
import { CheckProxyResponse } from 'packages/proxy-dashboard/interfaces';
  ...
  extraReducers(builder) {
    builder
      ...
      .addCase(recheckProxy.pending, (state, action) => {
        ...
        state.proxyList.Proxies = state.proxyList.Proxies.map(
          (proxy) => {
...
export const getProxyStatus = (state: RootState) =>
