...
const validator: ValidatorPattern = {
  fullname: {
    ...
    minLength: {
      value: 3,
      message:
        'Full name must be greater than two characters'
    },
    maxLength: {
      value: 49,
      message:
        'Full name must be less than fifty characters'
    }
  },
  name: {
    ...
    maxLength: {
      value: 99,
      message:
        'Name must be less than hundrad characters'
    }
  },
  email: {
...
> {
  ...
  lunch() {
    for (const name in this
      ...
      const value: ValidationRule<any> =
