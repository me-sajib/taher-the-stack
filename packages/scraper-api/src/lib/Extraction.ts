...
class Extraction {
      ...
      if (typeof result === 'object') {
        for (const key in result) {
          ...
          if (
            ...
            result[key] = this.cleaner(
              value as ExtractResponse
            );
          } else {
            result[key] =
              this.clean(value);
  ...
  private documentScraper(
    ...
    const scrapeOption = (
      ...
      if (
        dto.output &&
        typeof dto.output === 'object'
      ) {
        try {
          console.log(
            'nested scraper started'
          );
